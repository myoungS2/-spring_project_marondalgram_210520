...
<div class="form-group">
	<form id="loginForm" action="/user/sign_in" method="post">
		<div class="w-100">
			<input type="text" id="loginIdInput" name="loginIdInput" class="form-control mt-3" placeholder="ID">
			<input type="password" id="passwordInput" name="passwordInput" class="form-control mt-3"  placeholder="PASSWORD">
		</div>	
